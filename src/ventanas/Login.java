...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        ImageIcon wallpaper_logo = new ImageIcon("src/images/SS.png");
    ...
    private void initComponents() {
        ...
        jButton_Acceder.setBackground(new java.awt.Color(153, 153, 153));
        ...
        if (!user.equals("") || !pass.equals("")) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    } else if (tipo_nivel.equals("Vendedor") && estatus.equalsIgnoreCase("Activo")) {
                        dispose();
